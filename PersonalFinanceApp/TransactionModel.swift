...
extension Category {
    ...
    static let uber = Category(id: 102, name: "Uber", icon: .taxi, mainCategoryId: 1)
    static let mobilePhone = Category(id: 201, name: "Mobile Phone", icon: .mobile_alt, mainCategoryId: 2)
    static let streamingServices = Category(id: 301, name: "Streaming Services", icon: .film, mainCategoryId: 3)
    static let bankFee = Category(id: 401, name: "Bank Fees", icon: .hand_holding_usd, mainCategoryId: 4)
    static let financialCharge = Category(id: 402, name: "Financial Charge", icon: .hand_holding_usd, mainCategoryId: 4)
